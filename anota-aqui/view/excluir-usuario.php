...
if ($op == "Sim") {
    ...
    $registro = $query->excluirUsuario($_SESSION['id']);
...
<html>
    ...
    <head>
        ...
        <title>Excluir Artilharia - Anota Gols</title>
        ...
        <link href="../css/excluir-usuario.css" rel="stylesheet">
    ...
    <center>
        <h2 style="margin-top: 150px">Excluir usuario</h2>  
        <form method="post" style="margin-top: 50px; width: 350px; ">
            <h2 style="margin-top: 150px">Tem certeza? </h2>
            <input hidden name="sim" value="Sim">
            <input class="btn btn-primary" type="submit" name="sim" value="Sim">
            <button class="btn btn-primary" style="margin-left: 50px" name="excluir"><a href="minhas-informacoes.php" style="text-decoration: none; color: white">Não</a></button>
        </form>
    </center>
    <center>
