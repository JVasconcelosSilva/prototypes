...
<html lang="pt-br">
    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
            ...
            <br><br><br><br><br>
            <?php if (!is_null($nomeArtilharia)) { ?>
                <div class="container">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <h3>Artilharias Publicas</h3>
                                <table class="table table-bordered table-hover">
                                    <thead class="thead-dark">
                                    <th class="artilharia">Artilharia</th>
                                    <th class="dono">Dono</th>
                                    </thead >
                                    <tbody>
                                        <?php
                                        $query = new Artilharia("artilharia");
                                        $artilharias = $query->getArtilhariasByName($nomeArtilharia);
